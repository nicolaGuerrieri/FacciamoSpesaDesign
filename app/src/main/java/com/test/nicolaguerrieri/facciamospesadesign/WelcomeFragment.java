...
import com.test.nicolaguerrieri.facciamospesadesign.adapter.AdapterGallery;
...
/**
        Gallery gallery = (Gallery) view.findViewById(R.id.galleryMy);

        gallery.setAdapter(new AdapterGallery(getActivity(), imageIDs));
